...
const Sidebar = () => {
  ...
  return (
    <div className="relative font-sans">
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen scrollbar-hidden overflow-auto w-64 bg-[#F9E8C9] flex flex-col justify-between border-r border-[#E3D3B7] p-6 z-40 transform ${
